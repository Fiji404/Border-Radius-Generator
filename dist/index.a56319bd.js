...
buttonCopyToClipboard.addEventListener("click", ()=>{
    ...
    border-radius: ${checkElementStyle(elementLivePreview.style.borderTopLeftRadius)} ${checkElementStyle(elementLivePreview.style.borderTopRightRadius)} ${checkElementStyle(elementLivePreview.style.borderBottomLeftRadius)} ${checkElementStyle(elementLivePreview.style.borderBottomRightRadius)};
    `;
